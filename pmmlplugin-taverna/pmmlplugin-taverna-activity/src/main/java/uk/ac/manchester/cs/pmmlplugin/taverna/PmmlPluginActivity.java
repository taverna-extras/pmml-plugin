...
public class PmmlPluginActivity extends
		AbstractAsynchronousActivity<PmmlPluginActivityConfigurationBean>
		implements AsynchronousActivity<PmmlPluginActivityConfigurationBean> {
	...
	/* Service ports:
	 * OUT_PMML_FILE is a String reference to a PMML file (either .xml or .pmml)
	 */
	private static final String OUT_PMML_FILE = "pmmlFile";
	
	private PmmlPluginActivityConfigurationBean configBean;

	@Override
	public void configure(PmmlPluginActivityConfigurationBean configBean)
		...
		if (configBean.getPmmlFile().equals("invalidExample")) {
			throw new ActivityConfigurationException(
...
//				}
				...
				Map<String, T2Reference> outputs = new HashMap<String, T2Reference>();
				String pmmlFile = configBean.getPmmlFile(); //"/home/test.pmml";
